...
class Contrato:
    ...
    def gerar_parcelas_csv(self, nome_arquivo: str = "parcelas.csv"):
        """
        Gera um arquivo CSV com as parcelas do contrato.
        
        Args:
            nome_arquivo: Nome do arquivo CSV (padrão: parcelas.csv)
        """
        import csv
        ...
        with open(nome_arquivo, 'w', newline='', encoding='utf-8-sig') as arquivo:
            writer = csv.writer(arquivo, delimiter=';')  # ; funciona melhor no Excel BR
